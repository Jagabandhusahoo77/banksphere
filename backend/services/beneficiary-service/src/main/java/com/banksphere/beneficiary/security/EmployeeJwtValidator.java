 ...
 * — the same stateless-verification pattern {@link JwtValidator} uses for
 * customer-service's tokens, a second instance for a second principal
 * type. A token signed with the customer {@code JWT_SECRET} fails
