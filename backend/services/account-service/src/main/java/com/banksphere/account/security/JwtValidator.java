...
/**
 * Validates JWTs issued by customer-service using the same shared HMAC
 * secret ({@code JWT_SECRET}) — stateless verification, no callback to
...
public class JwtValidator {
    ...
    /** Returns the token's claims if the signature and expiration are both valid, or empty otherwise. */
